...
public class DumAemExtSampleDeltaDate implements DumAemExtDeltaDateInterface {
    @Override
    public Date consume(DumAemObject aemObject, DumAemConfiguration dumAemSourceContext) {
