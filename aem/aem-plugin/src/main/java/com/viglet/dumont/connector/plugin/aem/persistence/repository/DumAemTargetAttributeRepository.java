...
public interface DumAemTargetAttributeRepository extends JpaRepository<DumAemTargetAttribute, String> {
    List<DumAemTargetAttributeRepository> findByDumAemModel(DumAemModel dumAemModel);
}
