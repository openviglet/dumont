...
public interface DumAemSourceLocalePathRepository extends JpaRepository<DumAemSourceLocalePath, String> {
    Optional<Collection<DumAemSourceLocalePath>> findByDumAemSource(DumAemSource dumAemSource);
}
