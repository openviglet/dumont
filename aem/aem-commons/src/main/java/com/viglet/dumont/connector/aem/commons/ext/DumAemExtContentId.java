...
@Slf4j
public class DumAemExtContentId implements DumAemExtAttributeInterface {
	...
	public TurMultiValue consume(DumAemTargetAttr dumAemTargetAttr,
		...
		log.debug("Executing DumAemExtContentId");
		return TurMultiValue.singleItem(String.format("%s", aemObject.getPath()));
