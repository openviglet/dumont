...
@Slf4j
public class DumAemExtCreationDate implements DumAemExtAttributeInterface {
	@Override
	public TurMultiValue consume(DumAemTargetAttr dumAemTargetAttr,
		...
		log.debug("Executing DumAemExtCreationDate");
		return Optional.ofNullable(aemObject.getCreatedDate())
				.map(createdDate -> TurMultiValue.singleItem(createdDate.getTime())).orElse(null);
	}
