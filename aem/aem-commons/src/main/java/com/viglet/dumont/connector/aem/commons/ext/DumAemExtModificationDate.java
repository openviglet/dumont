...
@Slf4j
public class DumAemExtModificationDate implements DumAemExtAttributeInterface {
	@Override
	public TurMultiValue consume(DumAemTargetAttr dumAemTargetAttr,
		...
		log.debug("Executing DumAemExtModificationDate");
		return TurMultiValue.singleItem(getLastModifiedDate(aemObject));
	}

	public static Date getLastModifiedDate(DumAemObject aemObject) {
		return Optional.ofNullable(aemObject.getLastModified()).map(Calendar::getTime)
