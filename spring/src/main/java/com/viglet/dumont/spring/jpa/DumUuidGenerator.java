...
public class DumUuidGenerator extends UuidGenerator {
    public DumUuidGenerator(DumUuid config, Member idMember, CustomIdGeneratorCreationContext creationContext) {
