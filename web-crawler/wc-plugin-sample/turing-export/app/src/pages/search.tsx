      ...
      <div className="flex flex-1 flex-col gap-3 p-5">
        ...
        {siteName && (
          <div className="flex items-center gap-1.5 pt-1">
            <Badge
              variant="outline"
              className="text-[10px] py-0 h-5 bg-amber-500/10 text-amber-300 border-amber-500/20"
            >
              {siteName}
            </Badge>
          </div>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        {/* Decorative animated dots/particles */}
        ...
        <div className="absolute top-24 left-[60%] size-1.5 rounded-full bg-rose-400/15 animate-pulse [animation-delay:1.5s]" />
        <div className="absolute bottom-8 right-[25%] size-2 rounded-full bg-orange-300/20 animate-pulse [animation-delay:2s]" />
        <div className="absolute top-12 right-[40%] size-1 rounded-full bg-amber-500/15 animate-pulse [animation-delay:0.7s]" />
          ...
          {isLanding && (
            <>
              ...
              <p className="mt-4 max-w-xl mx-auto text-muted-foreground text-base sm:text-lg leading-relaxed">
                Discover the sum of all human knowledge. Search millions of
                articles across every field of science, history, art, and
                technology.
                {totalCount > 0 && (
                  <span className="block mt-1 text-primary/80 font-medium">
                    {totalCount} articles indexed
                  </span>
                )}
              </p>
            </>
            ...
            <div className="relative group">
              ...
              <div className="relative flex items-center gap-2 rounded-xl border border-border/60 bg-card/80 backdrop-blur-sm px-4 py-2 shadow-lg shadow-primary/5 group-focus-within:border-primary/40">
                ...
                <TuringSearchField.Input
                  placeholder="Search Wikipedia... Einstein, quantum, rainforest..."
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-1 gap-8 px-4 sm:px-6 pb-12">
        ...
        {turing.status === "error" && (
          <div className="flex flex-1 flex-col items-center justify-center gap-3 py-24 text-center">
            <IconBook2 className="size-10 text-destructive/60" />
            <p className="text-sm text-destructive/80">
              The page could not be loaded. {turing.error}
            </p>
        ...
        {turing.status === "idle" && (
          <div className="flex flex-1 flex-col items-center justify-center gap-3 py-16 text-center">
            <IconBook2 className="size-10 text-primary/40" />
            <p className="text-muted-foreground text-sm max-w-md">
              Enter a search query or browse the full collection. Every article
