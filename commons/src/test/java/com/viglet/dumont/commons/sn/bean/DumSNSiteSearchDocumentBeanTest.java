...
/**
 * Unit tests for DumSNSiteSearchDocumentBean.
 *
 * @author Alexandre Oliveira
 * @since 0.3.4
 */
class DumSNSiteSearchDocumentBeanTest {

    @Test
    void testBuilderPattern() {
        List<DumSNSiteSearchDocumentMetadataBean> metadata = Arrays.asList(
                DumSNSiteSearchDocumentMetadataBean.builder().build());
        Map<String, Object> fields = new HashMap<>();
        fields.put("title", "Test Document");
        fields.put("content", "Test content");

        DumSNSiteSearchDocumentBean document = DumSNSiteSearchDocumentBean.builder()
                .source("test-source")
                .elevate(true)
                .metadata(metadata)
                .fields(fields)
    ...
    void testSettersAndGetters() {
        ...
        DumSNSiteSearchDocumentBean document = DumSNSiteSearchDocumentBean.builder().build();

        List<DumSNSiteSearchDocumentMetadataBean> metadata = new ArrayList<>();
        Map<String, Object> fields = new HashMap<>();
        fields.put("id", "123");
    ...
    void testMetadataManipulation() {
        ...
        // Add metadata
        DumSNSiteSearchDocumentMetadataBean meta1 = DumSNSiteSearchDocumentMetadataBean.builder().build();
        DumSNSiteSearchDocumentMetadataBean meta2 = DumSNSiteSearchDocumentMetadataBean.builder().build();
