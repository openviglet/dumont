 ...
 * @since 0.3.9
 */
class DumFileAttributesTest {

    @Test
    void testDefaultConstructor() {
        DumFileAttributes attributes = new DumFileAttributes();
    ...
    void testBuilderPattern() {
        ...
        DumFileSize testSize = new DumFileSize();
        Map<String, String> testMetadata = new HashMap<>();
        testMetadata.put("author", "Test Author");

        DumFileAttributes attributes = DumFileAttributes.builder()
    ...
    void testSettersAndGetters() {
        ...
        DumFileSize newSize = new DumFileSize();
    ...
    @Test
    void testToBuilder() {
        DumFileAttributes original = DumFileAttributes.builder()
        ...
        DumFileAttributes modified = original.toBuilder()
    ...
    void testDefaultValues() {
        DumFileAttributes attributes = DumFileAttributes.builder().build();
