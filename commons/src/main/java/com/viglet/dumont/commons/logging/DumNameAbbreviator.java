 ...
 */
public abstract class DumNameAbbreviator {

    /**
     * Abbreviator that drops starting path elements.
     */
    private static class DropElementAbbreviator extends DumNameAbbreviator {
        /**
     ...
     * Abbreviator that drops starting path elements.
     */
    private static class MaxElementAbbreviator extends DumNameAbbreviator {
        /**
         * Maximum number of path elements to output.
         */
        private final int count;
     ...
     */
    private static class NOPAbbreviator extends DumNameAbbreviator {
        /**
         * Constructor.
         */
     ...
     *
     */
    private static class PatternAbbreviator extends DumNameAbbreviator {
        /**
     ...
     * @param ellipsis  Character used to represent dropped characters. '\0'
     *                  indicates no representation of dropped characters.
     */
     ...
     */
    private static final DumNameAbbreviator DEFAULT = new NOPAbbreviator();

    /**
     * Gets an abbreviator.
     * For example, "%logger{2}" will output only 2 elements of the logger name,
     * %logger{-2} will drop 2 elements from the
     * logger name, "%logger{1.}" will output only the first character of the
     * non-final elements in the name,
     * "%logger{1~.2~} will output the first character of the first element, two
     * characters of the second and subsequent
     ...
     */
    public static DumNameAbbreviator getAbbreviator(final String pattern) {
        if (!pattern.isEmpty()) {
