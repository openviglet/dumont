...
@Slf4j
public class DumAemExtSourceApps implements DumAemExtAttributeInterface {
	@Override
	public TurMultiValue consume(DumAemTargetAttr dumAemTargetAttr,
		...
		log.debug("Executing DumAemExtSourceApps");
		return TurMultiValue.singleItem(dumAemConfiguration.getProviderName());
	}
}
