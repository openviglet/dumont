 ...
 */
package com.viglet.dumont.connector.db.format;

import com.viglet.dumont.connector.db.DumDbImportTool;
 ...
 *
 **/
public class DumDbFormatValue {
	private static final String ID = "id";
	private final DumDbImportTool jdbcImportTool;

	public DumDbFormatValue(DumDbImportTool jdbcImportTool) {
