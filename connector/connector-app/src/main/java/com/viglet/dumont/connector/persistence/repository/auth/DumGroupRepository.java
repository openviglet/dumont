...
public interface DumGroupRepository extends JpaRepository<DumGroup, String> {
    DumGroup findByName(String name);
    Set<DumGroup> findByDumUsersContaining(DumUser user);
}
